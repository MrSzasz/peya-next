...
//                     será mobile, si no se selecciona (no se deja el tick ✔), se
//                     agregará como desktop. Se debe generar un slider por
//                     posición (ejemplo, si se generará un slider con una promo
//                     del 50% se debe generar uno para mobile y uno para desktop)
//                     <br />
//                     <span>ALT: </span> es el texto alternativo (no videntes) que
...
//     const queryCollectionHero = query(collection(db, "hero"), orderBy("sort"));
...
//     const queryCollectionPromos = query(
